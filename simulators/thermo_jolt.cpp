...
int main(int argc, char** argv) {
    ...
    std::string output_hard = joinPaths(
        output_dir, 
        std::string("kernel_hard_") + std::to_string(cpu_clk_idx) + "-" + std::to_string(ram_clk_idx) + "_" 
                                    + std::to_string(pulse_cpu_clk_idx) + "-" + std::to_string(pulse_ram_clk_idx) + std::string(".txt")
    );
